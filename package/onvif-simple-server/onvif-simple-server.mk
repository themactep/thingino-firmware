...
ONVIF_SIMPLE_SERVER_VERSION = f138f0b97d1cfd7d103b55428fca9975eb065751
...
# it is baked into util.c
ONVIF_SIMPLE_SERVER_DEPENDENCIES += zlib

ifeq ($(BR2_PACKAGE_MBEDTLS),y)
ONVIF_SIMPLE_SERVER_DEPENDENCIES += mbedtls json-c
MAKE_OPTS += HAVE_MBEDTLS=y
else ifeq ($(BR2_PACKAGE_THINGINO_WOLFSSL),y)
ONVIF_SIMPLE_SERVER_DEPENDENCIES += thingino-wolfssl json-c
