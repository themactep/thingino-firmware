...
THINGINO_DEVSCRIPTS_SITE = $(BR2_EXTERNAL_THINGINO_PATH)/package/thingino-devscripts

define THINGINO_DEVSCRIPTS_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0755 $(THINGINO_DEVSCRIPTS_PKGDIR)/files/ansi-colors \
		$(TARGET_DIR)/usr/sbin/ansi-colors
