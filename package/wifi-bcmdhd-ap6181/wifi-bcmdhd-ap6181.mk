WIFI_BCMDHD_AP6181_VERSION = 1.0
WIFI_BCMDHD_AP6181_SITE = $(WIFI_BCMDHD_AP6181_PKGDIR)/files
#WIFI_BCMDHD_AP6181_SITE = $(LINUX_DIR)/drivers/net/wireless/bcmdhd_6214
WIFI_BCMDHD_AP6181_SITE_METHOD = local

BCMDHD_AP6181_MODULE_NAME = bcmdhd
BCMDHD_AP6181_MODULE_OPTS = "gpio_wl_reg_on=48 gpio_wl_host_wake=39 firmware_path=/usr/lib/firmware/ nvram_path=/usr/lib/firmware/nv_bcm4343.txt op_mode=2"

define WIFI_BCMDHD_AP6181_LINUX_CONFIG_FIXUPS
...
define WIFI_BCMDHD_AP6181_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0644 $(WIFI_BCMDHD_AP6181_PKGDIR)/files/fw_bcm43438a1.bin \
		$(TARGET_DIR)/usr/lib/firmware/fw_bcm43438a1.bin

	$(INSTALL) -D -m 0644 $(WIFI_BCMDHD_AP6181_PKGDIR)/files/nv_bcm43438a1.txt \
