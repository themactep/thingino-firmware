...
WIFI_ATBM6012BX_VERSION = 1d2f714e616b990de5453bb862a0175617aca231
# $(shell git ls-remote $(WIFI_ATBM6012BX_SITE) $(WIFI_ATBM6012BX_SITE_BRANCH) | head -1 | cut -f1)
...
define WIFI_ATBM6012BX_INSTALL_CONFIGS
	...
	$(INSTALL) -m 644 $(@D)/firmware/firmware_lite_usb.bin $(TARGET_DIR)/lib/firmware/$(call qstrip,$(ATBM6012BX_MODULE_NAME))_fw.bin
endef
WIFI_ATBM6012BX_POST_INSTALL_TARGET_HOOKS += WIFI_ATBM6012BX_INSTALL_CONFIGS

define WIFI_ATBM6012BX_COPY_CONFIG
	$(INSTALL) -m 644 $(@D)/configs/atbm6012bx.config $(@D)/.config
endef
