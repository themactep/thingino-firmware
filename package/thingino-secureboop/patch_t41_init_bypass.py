#!/usr/bin/env python3
"""Inject a T41 pre-verification init-table bypass into a firmware image.

Same mechanism as the T32/T40 bypass: writes an INGE init-table entry that
clears the secure-boot enable flag before the bootrom performs signature
verification.  T41 uses a different secureboot register address.
"""
