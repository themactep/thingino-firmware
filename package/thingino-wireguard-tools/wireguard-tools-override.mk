...
override WIREGUARD_TOOLS_HASH_FILES = \
	$(BR2_EXTERNAL_THINGINO_PATH)/package/all-patches/wireguard-tools/wireguard-tools.hash
...
define WIREGUARD_TOOLS_INSTALL_WEBUI
	...
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_THINGINO_PATH)/package/thingino-wireguard-tools/files/www/config-wireguard.html \
		$(TARGET_DIR)/var/www/config-wireguard.html
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_THINGINO_PATH)/package/thingino-wireguard-tools/files/www/a/config-wireguard.js \
		$(TARGET_DIR)/var/www/a/config-wireguard.js
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_THINGINO_PATH)/package/thingino-wireguard-tools/files/www/a/wireguard.svg \
		$(TARGET_DIR)/var/www/a/wireguard.svg
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_THINGINO_PATH)/package/thingino-wireguard-tools/files/www/x/json-config-wireguard.cgi \
		$(TARGET_DIR)/var/www/x/json-config-wireguard.cgi
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_THINGINO_PATH)/package/thingino-wireguard-tools/files/www/x/json-wireguard.cgi \
		$(TARGET_DIR)/var/www/x/json-wireguard.cgi
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_THINGINO_PATH)/package/thingino-wireguard-tools/files/wireguard.webui.json \
...
define WIREGUARD_TOOLS_INSTALL_SCRIPTS
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_THINGINO_PATH)/package/thingino-wireguard-tools/files/S42wireguard \
		$(TARGET_DIR)/etc/init.d/S42wireguard
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_THINGINO_PATH)/package/thingino-wireguard-tools/files/wireguard-watchdog \
