...
F = $(patsubst "%",%,$(BR2_SOC_FAMILY))
S = $(patsubst "%",%,$(BR2_SENSOR_MODEL))
...
define INGENIC_OSDRV_T21_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 644 $(INGENIC_OSDRV_T21_PKGDIR)/files/kmod/tx-isp-$(F).ko $(TARGET_DIR)/lib/modules/3.10.14__isvp_turkey_1.0__/ingenic/tx-isp-$(F).ko

	$(INSTALL) -m 644 $(INGENIC_OSDRV_T21_PKGDIR)/files/kmod/sensor_$(S)_$(F).ko $(TARGET_DIR)/lib/modules/3.10.14__isvp_turkey_1.0__/ingenic/sensor_$(S)_$(F).ko
