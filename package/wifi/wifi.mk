...
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_AIC8800,aic8800_fdrv))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6012B,atbm6012b))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6012BX,atbm6012bx))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6031,atbm6031))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6031X,atbm6031x))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6032,atbm6032))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6032X,atbm6032x))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6041,atbm6041))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6132S,atbm6132s))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6132U,atbm6132u))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6062S,atbm6062s))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6062CU,atbm6062cu))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATBM6062U,atbm6062u))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_ATBM6441,atbm6441))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_ATK9,atk9))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_BCM43438,bcmdhd))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_BCMDHD_AP6214A,bcmdhd))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_HI3881,hi3881))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_MT7601U,mt7601sta))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_RTL8188EU,8188eu))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_RTL8188EUS,8188eu))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_RTL8188FU,8188fu))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_RTL8189ES,8189es))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_RTL8189FS,8189fs))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_RTL8192FS,8192fs))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_RTL8192EU,8192eu))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_RTL8812AU,8812au))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_RTL8733BU,8733bu))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_SSV6X5X,ssv6x5x))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_SSV6158,ssv6158))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_SSW101B,ssw101b))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_SYN4343,bcmdhd))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_TXW901U,txw901u))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_WS73V100,ws73v100))
$(eval $(call WIFI_ADD_DRIVER,BR2_PACKAGE_WIFI_WQ9001,wq9001))
...
WIFI_MODULE_IS_SDIO := $(filter $(WIFI_SDIO_MODULES),$(WLAN_MODULE))
