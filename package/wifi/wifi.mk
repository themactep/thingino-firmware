...
WIFI_INTERFACE_IS_USB_FLAG := 0
WIFI_INTERFACE_IS_PCIE_FLAG := 0
WIFI_INTERFACE_IS_UNKNOWN_FLAG := 0

ifeq ($(WIFI_INTERFACE),sdio)
WIFI_MODULE_IS_SDIO_FLAG := 1
else ifeq ($(WIFI_INTERFACE),usb)
WIFI_INTERFACE_IS_USB_FLAG := 1
else ifeq ($(WIFI_INTERFACE),pcie)
WIFI_INTERFACE_IS_PCIE_FLAG := 1
else
WIFI_INTERFACE_IS_UNKNOWN_FLAG := 1
endif
...
WIFI_TEMPLATE_VARS = \
	...
	--var WIFI_INTERFACE_IS_USB=$(WIFI_INTERFACE_IS_USB_FLAG) \
	--var WIFI_INTERFACE_IS_PCIE=$(WIFI_INTERFACE_IS_PCIE_FLAG) \
	--var WIFI_INTERFACE_IS_UNKNOWN=$(WIFI_INTERFACE_IS_UNKNOWN_FLAG) \
