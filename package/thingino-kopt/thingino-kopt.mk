...
ifeq ($(BR2_PACKAGE_THINGINO_KOPT_MMC0_PB_1BIT),y)
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_MMC0_PB_1BIT
	$(call KCONFIG_ENABLE_OPT,CONFIG_JZMMC_V12_MMC0_PB_1BIT)
endef
endif
...
ifeq ($(BR2_PACKAGE_THINGINO_KOPT_MMC1_PB_1BIT),y)
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_MMC1_PB_1BIT
	$(call KCONFIG_ENABLE_OPT,CONFIG_JZMMC_V12_MMC1_PB_1BIT)
endef
endif
...
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS
	...
	$(call THINGINO_KOPT_LINUX_CONFIG_FIXUPS_MMC0_PB_1BIT)
	$(call THINGINO_KOPT_LINUX_CONFIG_FIXUPS_MMC0_PB_4BIT)
	$(call THINGINO_KOPT_LINUX_CONFIG_FIXUPS_MMC0_PB_8BIT)
	$(call THINGINO_KOPT_LINUX_CONFIG_FIXUPS_MMC1_PB_1BIT)
