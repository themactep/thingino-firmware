...
ifeq ($(BR2_PACKAGE_THINGINO_KOPT_DWC2),y)
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_DWC2_PROBE_DELAY
	$(call KCONFIG_SET_OPT,CONFIG_USB_JZ_DWC2_PROBE_DELAY_MS,$(BR2_THINGINO_DWC2_PROBE_DELAY_MS))
endef
endif
################ UART #########################
...
################ WDT #########################
################ I2C #########################
ifeq ($(BR2_PACKAGE_THINGINO_KOPT_I2C_BUS1_HW),y)
...
ifeq ($(BR2_PACKAGE_THINGINO_KOPT_I2C_BUS1_GPIO),y)
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS_I2C1
	$(call KCONFIG_ENABLE_OPT,CONFIG_I2C_GPIO)
	$(call KCONFIG_ENABLE_OPT,CONFIG_SOFT_I2C1_GPIO_V12_JZ)
endef
endif
...
define THINGINO_KOPT_LINUX_CONFIG_FIXUPS
	...
	$(call THINGINO_KOPT_LINUX_CONFIG_FIXUPS_DWC2_PROBE_DELAY)
