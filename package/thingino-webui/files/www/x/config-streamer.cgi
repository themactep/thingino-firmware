...
<nav class="navbar navbar-expand-lg mb-4 p-1">
  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#nbStreamer"
    aria-controls="nbStreamer" aria-label="Toggle navigation">
  ...
  <div class="col mb-3">
    <div class="btn-toolbar" role="toolbar">
      <div class="btn-group mb-3" role="group">
        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#mdPreview" title="Full-screen">
