...
printf '{"steps_pan":%s,"steps_tilt":%s,"accel_pan":%s,"accel_tilt":%s,"motion_driver":"%s","pos_0_x":%s,"pos_0_y":%s}' "$steps_pan_val" "$steps_tilt_val" "$accel_pan_val" "$accel_tilt_val" "$motion_driver_val" "$pos_0_x_val" "$pos_0_y_val"
