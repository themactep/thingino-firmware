...
if [ "POST" = "$REQUEST_METHOD" ]; then
  ...
  jct /etc/thingino.json set wlan_ap.enabled "$POST_wlanap_enabled"
      ...
      <div class="card <%= $i %>">
        ...
        <div class="card-body">
          <div class="input-group mb-3">
            ...
            <button class="btn btn-secondary generate-mac-address" type="button" data-iface="<%= $i %>" title="Generate MAC address">
