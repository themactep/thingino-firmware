...
// Endpoint links are rendered by the shared /a/preview-endpoints.js module.
...
function handleMessage(msg) {
  ...
  if (window.thinginoPreviewEndpoints) {
    window.thinginoPreviewEndpoints.updateState(msg);
  }
}
...
loadInitialData().then(async () => {
  ...
  // preview element via CSS (img-fluid). Sending a canvas-derived size would
  // force the encoder to software-scale and overload the CPU.
