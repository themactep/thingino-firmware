...
override define LIVE555_BUILD_CMDS
	...
	$(if $(filter y,$(BR2_PACKAGE_THINGINO_RAPTOR_RSD555)), \
...
# live555 is only linked statically by raptor's rsd-555; nothing needs to
# ship on the target.
override define LIVE555_INSTALL_TARGET_CMDS
	:
endef

override LIVE555_CFLAGS += -DALLOW_RTSP_SERVER_PORT_REUSE
