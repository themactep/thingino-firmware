...
THINGINO_LIVE555_VERSION = 73f015a0c13e97cd9be49af07e7779961a327699
...
define THINGINO_LIVE555_CONFIGURE_CMDS
	echo 'COMPILE_OPTS = $$(INCLUDES) -I. -DSOCKLEN_T=socklen_t -DALLOW_RTSP_SERVER_PORT_REUSE $(THINGINO_LIVE555_CFLAGS)' >> $(@D)/config.$(THINGINO_LIVE555_CONFIG_TARGET)
