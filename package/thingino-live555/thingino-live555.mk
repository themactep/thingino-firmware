...
THINGINO_LIVE555_VERSION = a9360c4627bcc47d05fee891520045c88aa7982a
...
define THINGINO_LIVE555_CONFIGURE_CMDS
	echo 'COMPILE_OPTS = $$(INCLUDES) -I. -DSOCKLEN_T=socklen_t -DALLOW_RTSP_SERVER_PORT_REUSE -DNO_STD_LIB -DOUT_PACKET_BUFFER_MAX_SIZE=20000000 $(THINGINO_LIVE555_CFLAGS)' >> $(@D)/config.$(THINGINO_LIVE555_CONFIG_TARGET)
