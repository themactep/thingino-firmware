...
AIC8800_MODULE_NAME = aic8800_fdrv
AIC8800_MODULE_OPTS =

WIFI_AIC8800_MODULE_MAKE_OPTS = \
	CONFIG_USE_WIRELESS_EXT=n \
	CONFIG_RWNX_RADAR=n \
	INSTALL_MOD_STRIP=1

ifeq ($(BR2_PACKAGE_WIFI_AIC8800_USB_8800),y)
WIFI_AIC8800_MODULE_MAKE_OPTS += CONFIG_AIC_CHIP_8800=y
endif

ifeq ($(BR2_PACKAGE_WIFI_AIC8800_USB_8800D80),y)
WIFI_AIC8800_MODULE_MAKE_OPTS += CONFIG_AIC_CHIP_8800D80=y
endif

ifeq ($(BR2_PACKAGE_WIFI_AIC8800_USB_8800D80X2),y)
WIFI_AIC8800_MODULE_MAKE_OPTS += CONFIG_AIC_CHIP_8800D80X2=y
endif

ifeq ($(BR2_PACKAGE_WIFI_AIC8800_USB_8800DC),y)
WIFI_AIC8800_MODULE_MAKE_OPTS += CONFIG_AIC_CHIP_8800DC=y
endif
...
# Minimal subset for on H-variant devices only
...
# for non-H variants
ifeq ($(BR2_PACKAGE_WIFI_AIC8800_USB_8800D80_H_FIRMWARE_ONLY),)
WIFI_AIC8800_USB_8800D80_FW_FILES += \
	fmacfw_8800d80_h_u02.bin
endif
