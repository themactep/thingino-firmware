...
WIFI_ATBM6132U_VERSION = $(shell git ls-remote $(WIFI_ATBM6132U_SITE) $(WIFI_ATBM6132U_SITE_BRANCH) | head -1 | cut -f1)
...
define WIFI_ATBM6132U_INSTALL_CONFIGS
	...
	$(INSTALL) -m 644 $(@D)/firmware/firmware_mercurius_usb.bin $(TARGET_DIR)/lib/firmware/$(call qstrip,$(ATBM6132U_MODULE_NAME))_fw.bin
endef
WIFI_ATBM6132U_POST_INSTALL_TARGET_HOOKS += WIFI_ATBM6132U_INSTALL_CONFIGS

define WIFI_ATBM6132U_COPY_CONFIG
	$(INSTALL) -m 644 $(@D)/configs/atbm6132u.config $(@D)/.config
endef
