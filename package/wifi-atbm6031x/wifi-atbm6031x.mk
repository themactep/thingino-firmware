...
WIFI_ATBM6031X_VERSION = 13953b6e9090e620640edf4c6ea8ffc2e46da6b4

WIFI_ATBM6031X_LICENSE = GPL-2.0

ATBM6031X_MODULE_NAME = atbm6031x
ATBM6031X_MODULE_OPTS = atbm_printk_mask=0

WIFI_ATBM6031X_MODULE_MAKE_OPTS = \
	KDIR=$(LINUX_DIR)

define WIFI_ATBM6031X_LINUX_CONFIG_FIXUPS
...
ifeq ($(BR2_PACKAGE_THINGINO_BLUETOOTH),y)
	ATBM6031X_MODULE_OPTS += wifi_bt_comb=1
	WIFI_ATBM6031X_MODULE_MAKE_OPTS += EXTRA_CFLAGS="-DCONFIG_WIFI_BT_COMB -DCONFIG_ATBM_BLE_ADV_COEXIST"
