...
WIFI_ATBM6031X_VERSION = 23d2f103b2f23e87de60ac0640a3eebd87001bd0

WIFI_ATBM6031X_LICENSE = GPL-2.0

ATBM6031X_MODULE_NAME = "atbm6031x"

WIFI_ATBM6031X_MODULE_MAKE_OPTS = \
	KDIR=$(LINUX_DIR)

define WIFI_ATBM6031X_LINUX_CONFIG_FIXUPS_WIFI
...
define WIFI_ATBM6031X_LINUX_CONFIG_FIXUPS_BLE
	$(call KCONFIG_SET_OPT,CONFIG_BT,y)
        $(call KCONFIG_ENABLE_OPT,CONFIG_BT_HCIBTSDIO)
endef

WIFI_ATBM6031X_LINUX_CONFIG_FIXUPS = WIFI_ATBM6031X_LINUX_CONFIG_FIXUPS_WIFI
...
define WIFI_ATBM6031X_COPY_CONFIG_BLE
...
ifeq ($(BR2_PACKAGE_THINGINO_BLUETOOTH),y)
	...
	WIFI_ATBM6031X_LINUX_CONFIG_FIXUPS += WIFI_ATBM6031X_LINUX_CONFIG_FIXUPS_BLE
	WIFI_ATBM6031X_POST_INSTALL_TARGET_HOOKS += WIFI_ATBM6031X_INSTALL_CONFIGS_BLE
	WIFI_ATBM6031X_PRE_CONFIGURE_HOOKS += WIFI_ATBM6031X_COPY_CONFIG_BLE
else
	WIFI_ATBM6031X_POST_INSTALL_TARGET_HOOKS += WIFI_ATBM6031X_INSTALL_CONFIGS_WIFI
endif
