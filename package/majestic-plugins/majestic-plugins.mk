...
define MAJESTIC_PLUGINS_BUILD_CMDS
	$(MAKE) CC=$(TARGET_CC) TARGET=$(SOC_VENDOR) -C $(MAJESTIC_PLUGINS_PATH) -B
endef
else
define MAJESTIC_PLUGINS_BUILD_CMDS
	$(MAKE) CC=$(TARGET_CC) TARGET=$(SOC_VENDOR) -C $(@D) -B
endef

define MAJESTIC_PLUGINS_INSTALL_TARGET_CMDS
	$(INSTALL) -m 644 -t $(TARGET_DIR)/usr/lib $(@D)/$(SOC_VENDOR).so
endef
endif
