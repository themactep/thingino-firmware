...
WIFI_ATBM6031_VERSION = $(shell git ls-remote $(WIFI_ATBM6031_SITE) HEAD | head -1 | cut -f1)
...
#define WIFI_ATBM6031_INSTALL_TARGET_CMDS
...
#	$(INSTALL) -m 644 -t $(TARGET_DIR)/usr/share/atbm60xx_conf $(WIFI_ATBM6031_PKGDIR)/files/*.txt
#endef
