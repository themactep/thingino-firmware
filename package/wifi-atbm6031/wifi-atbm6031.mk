...
WIFI_ATBM6031_SITE = https://github.com/gtxaspec/atbm60xx
...
WIFI_ATBM6031_MODULE_MAKE_OPTS = \
	...
	CONFIG_ATBM_FW_NAME=$(ATBM6031_MODULE_NAME)_fw.bin \
	CONFIG_ATBM_WEXT=y \
	CONFIG_ATBM603x=y \
	CONFIG_ATBM_MODULE_NAME=$(ATBM6031_MODULE_NAME)
...
define WIFI_ATBM6031_INSTALL_CONFIGS
	...
	$(INSTALL) -m 644 $(@D)/firmware/Ares_B_Chip_IPC_SDIO_svn14195_24M_6031_6031B.bin $(TARGET_DIR)/lib/firmware/$(call qstrip,$(ATBM6031_MODULE_NAME))_fw.bin
endef
