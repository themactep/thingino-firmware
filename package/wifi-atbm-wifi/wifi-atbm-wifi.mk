...
WIFI_ATBM_WIFI_VERSION = $(shell git ls-remote $(WIFI_ATBM_WIFI_SITE) $(WIFI_ATBM_WIFI_SITE_BRANCH) | head -1 | cut -f1)
...
define WIFI_ATBM_WIFI_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 755 -d $(TARGET_DIR)/usr/share/atbm_wifi
	$(INSTALL) -m 644 -t $(TARGET_DIR)/usr/share/atbm_wifi $(WIFI_ATBM_WIFI_PKGDIR)/files/*.txt
endef
