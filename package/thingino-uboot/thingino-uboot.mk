...
ifneq ($(BR2_PACKAGE_THINGINO_UBOOT_USE_BINMAN),y)
THINGINO_UBOOT_MAKE_TARGET += u-boot.itb
endif
endif

ifeq ($(BR2_PACKAGE_THINGINO_UBOOT_FORMAT_QSPI_BIN),y)
THINGINO_UBOOT_BINS += qspi.bin
endif
...
ifeq ($(BR2_PACKAGE_THINGINO_UBOOT_TI_K3_BOOT_FIRMWARE),y)
...
ifeq ($(suffix $(THINGINO_UBOOT_ZYNQMP_PMUFW_PATH)),.elf)
THINGINO_UBOOT_ZYNQMP_PMUFW_PATH_FINAL = $(basename $(THINGINO_UBOOT_ZYNQMP_PMUFW_PATH)).bin
# objcopy is arch-agnostic so we can use $(TARGET_OBJCOPY) in lack of a
# microblaze objcopy
define THINGINO_UBOOT_ZYNQMP_PMUFW_CONVERT
	$(TARGET_OBJCOPY) -O binary -I elf32-little $(THINGINO_UBOOT_ZYNQMP_PMUFW_PATH) $(THINGINO_UBOOT_ZYNQMP_PMUFW_PATH_FINAL)
endef
THINGINO_UBOOT_PRE_BUILD_HOOKS += THINGINO_UBOOT_ZYNQMP_PMUFW_CONVERT
else
THINGINO_UBOOT_ZYNQMP_PMUFW_PATH_FINAL = $(THINGINO_UBOOT_ZYNQMP_PMUFW_PATH)
endif
define THINGINO_UBOOT_ZYNQMP_KCONFIG_PMUFW
	$(call KCONFIG_SET_OPT,CONFIG_PMUFW_INIT_FILE,"$(THINGINO_UBOOT_ZYNQMP_PMUFW_PATH_FINAL)")
endef
...
ifeq ($(BR2_PACKAGE_THINGINO_UBOOT_ZYNQ),y)
UBOOT_ZYNQ_PS7_INIT = $(call qstrip,$(BR2_PACKAGE_THINGINO_UBOOT_ZYNQ_PS7_INIT_FILE))
UBOOT_ZYNQ_PS7_INIT_PATH = $(shell readlink -f $(THINGINO_UBOOT_ZYNQ_PS7_INIT))

ifneq ($(THINGINO_UBOOT_ZYNQ_PS7_INIT),)
define THINGINO_UBOOT_ZYNQ_KCONFIG_PS7_INIT
	$(call KCONFIG_SET_OPT,CONFIG_XILINX_PS_INIT_FILE,"$(THINGINO_UBOOT_ZYNQ_PS7_INIT_PATH)")
endef
endif
endif # BR2_PACKAGE_THINGINO_UBOOT_ZYNQ
...
define THINGINO_UBOOT_KCONFIG_FIXUP_CMDS
	...
	$(THINGINO_UBOOT_ZYNQ_KCONFIG_PS7_INIT)
