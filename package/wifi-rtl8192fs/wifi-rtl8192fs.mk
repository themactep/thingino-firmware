...
RTL8192FS_MODULE_NAME = 8192fs
RTL8192FS_MODULE_OPTS =

WIFI_RTL8192FS_MODULE_MAKE_OPTS = \
	CONFIG_RTL8192FS=m

# wpa_supplicant handles roaming; disable the driver's own L2 roaming
WIFI_RTL8192FS_MODULE_MAKE_OPTS += BR2_PACKAGE_THINGINO_WPA_SUPPLICANT_ROAMING=$(BR2_PACKAGE_THINGINO_WPA_SUPPLICANT_ROAMING)
...
define WIFI_RTL8192FS_INSTALL_CONFIGS
	...
	$(INSTALL) -D -m 0644 $(WIFI_RTL8192FS_PKGDIR)/files/TXPWR_LMT.txt \
		$(TARGET_DIR)/usr/lib/firmware/TXPWR_LMT.txt
endef
