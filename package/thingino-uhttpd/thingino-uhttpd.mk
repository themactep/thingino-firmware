THINGINO_UHTTPD_VERSION = 373145f72c884c36a2b16f7f47e74ffae06bd754
THINGINO_UHTTPD_SITE = https://git.openwrt.org/project/uhttpd.git
THINGINO_UHTTPD_SITE_METHOD = git
THINGINO_UHTTPD_SITE_BRANCH = master
...
define THINGINO_UHTTPD_INSTALL_CONFIG
	...
	if [ "$(BR2_PACKAGE_THINGINO_UHTTPD_HTTP_REDIRECT)" = "y" ]; then \
		$(SED) 's|^UHTTPD_TLS_REDIRECT=.*|UHTTPD_TLS_REDIRECT="1"|' \
			$(TARGET_DIR)/etc/default/uhttpd; \
	fi
endef
