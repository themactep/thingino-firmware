LIBHELIX_MP3_VERSION = 2.4.2
LIBHELIX_MP3_SITE = $(call github,earlephilhower,ESP8266Audio,$(LIBHELIX_MP3_VERSION))
LIBHELIX_MP3_LICENSE = RPSL-1.0
LIBHELIX_MP3_LICENSE_FILES = src/libhelix-mp3/LICENSE.txt src/libhelix-mp3/RPSL.txt
