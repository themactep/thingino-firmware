...
WIFI_ATBM6062S_SITE = https://github.com/opensensor/atbm-wifi
WIFI_ATBM6062S_SITE_BRANCH = atbm-606x-clean
WIFI_ATBM6062S_VERSION = 663cba86c32f6f20dc3036b3c8a19c36627af2df
...
define WIFI_ATBM6062S_INSTALL_CONFIGS
	...
	$(INSTALL) -D -m 0644 $(@D)/firmware/cronus_SDIO_NoBLE_SDIO_svn19514_24M_wifi6phy_DCDC.bin \
		$(TARGET_DIR)/usr/lib/firmware/$(call qstrip,$(ATBM6062S_MODULE_NAME))_fw.bin
endef
else
define WIFI_ATBM6062S_INSTALL_CONFIGS
...
define WIFI_ATBM6062S_ENABLE_WEXT
...
endef
WIFI_ATBM6062S_POST_PATCH_HOOKS += WIFI_ATBM6062S_ENABLE_WEXT
