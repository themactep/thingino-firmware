WIFI_ATBM6062S_VERSION = custom
WIFI_ATBM6062S_SITE = $(TOPDIR)/../atbm-wifi
WIFI_ATBM6062S_SITE_METHOD = local
WIFI_ATBM6062S_DEPENDENCIES = linux

WIFI_ATBM6062S_LICENSE = GPL-2.0

ATBM6062S_MODULE_NAME = "atbm6062s"

define WIFI_ATBM6062S_INSTALL_MODULES
...
WIFI_ATBM6062S_POST_INSTALL_TARGET_HOOKS += WIFI_ATBM6062S_INSTALL_MODULES
...
define WIFI_ATBM6062S_CONFIGURE_CMDS
	$(INSTALL) -D -m 0644 $(@D)/configs/atbm6062s.config $(@D)/.config
endef

define WIFI_ATBM6062S_BUILD_CMDS
	@echo "Building hal_apollo/atbm6062s module with kernel 4.4 compat exports (SDIO, Ingenic T41)..."
	$(MAKE) -C $(LINUX_DIR) \
		ARCH=$(KERNEL_ARCH) \
		...
		MODULES_NAME=atbm6062s \
		ATBM_MODULES_NAME=atbm6062s \
		modules
endef
