...
WIFI_ATBM6062S_VERSION = $(shell git ls-remote $(WIFI_ATBM6062S_SITE) $(WIFI_ATBM6062S_SITE_BRANCH) | head -1 | cut -f1)
...
define WIFI_ATBM6062S_COPY_CONFIG
	$(INSTALL) -m 644 $(@D)/configs/atbm6062s.config $(@D)/.config
endef
