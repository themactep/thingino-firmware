...
RUN DEBIAN_FRONTEND=noninteractive TZ=Etc/UTC apt-get update && \
    ...
    lzop m4 mc mtools nano nodejs npm parted perl python3 python3-dev \
    python3-jinja2 python3-jsonschema python3-setuptools python3-yaml ripgrep \
    rsync shfmt ssh sudo swig u-boot-tools unzip vim wget whiptail \
    zlib1g-dev && \
