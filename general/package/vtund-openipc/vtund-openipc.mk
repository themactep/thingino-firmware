...
define VTUND_OPENIPC_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 755 -t $(TARGET_DIR)/usr/sbin $(BR2_EXTERNAL)/../general/package/vtund-openipc/files/tapip
	$(INSTALL) -m 755 -t $(TARGET_DIR)/usr/sbin $(BR2_EXTERNAL)/../general/package/vtund-openipc/files/tunnel
